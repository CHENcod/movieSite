...
function movieRandom_Btn() {
    ...
    <div class="col-12 col-md-6">
                    <img src="./image/movie_image/movie${arr[0]}.jpg" alt="">
                    <img src="./image/movie_image/movie${arr[1]}.jpg" alt="">
                    <img src="./image/movie_image/movie${arr[2]}.jpg" alt="">
                    <img src="./image/movie_image/movie${arr[3]}.jpg" alt="">
                    <img src="./image/movie_image/movie${arr[4]}.jpg" alt="">
                </div>
                <div class="col-12 col-md-6 movieRandom_mainContent">
                    <a href="#"><img src="./image/movie_image/movie${arr[0]}.jpg" alt=""></a>
                    <div>
                        <p>動作</p>
                        <p>評價：8</p>
...
function movieCity_Btn1() {
    ...
    <div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema1.jpg" alt="">
    <p>台北信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
<div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema2.jpg" alt="">
    <p id="">台北信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
<div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema3.jpg" alt="">
    <p>台北信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
<div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema4.jpg" alt="">
    <p>台北信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
    `
...
function movieCity_Btn2() {
    movieCity_Content_Div.innerHTML = ` 
    <div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema5.jpg" alt="">
    <p>台北信義威秀影城</p>
    <p>影城地址：台中市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
<div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema6.jpg" alt="">
    <p id="">台中信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
<div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema7.jpg" alt="">
    <p>台中信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
<div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema8.jpg" alt="">
    <p>台中信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
    `
...
function movieCity_Btn3() {
    movieCity_Content_Div.innerHTML = ` 
    <div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema9.jpg" alt="">
    <p>台南信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
<div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema10.jpg" alt="">
    <p id="">高雄信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
<div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema11.jpg" alt="">
    <p>高雄信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
<div class="col-6 col-lg-3"><a href="#"><img src="./image/cinema_image/cinema12.jpg" alt="">
    <p>台北信義威秀影城</p>
    <p>影城地址：台北市信義區松壽路20號<br>服務專線：(02) 8780-5566</p>
</a></div>
    `
